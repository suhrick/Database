...
SELECT SUBSTRING(digest_text,1,150) Text, SUM(count_star) executions, SUM(avg_timer_wait / 1000000000000) Avg_Run_Time, SUM(sum_timer_wait / 100000000000) Time_Consumed, SUM(sum_rows_examined) Rows_Examined
FROM
        stats_history
    WHERE
